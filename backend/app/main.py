...
from .routers import overview, regions, inequality, specialties, trends, export, status, ai as ai_router, news as news_router, simulator, anomaly, patient, alerts_sub, mutual_aid, pipeline as pipeline_router
